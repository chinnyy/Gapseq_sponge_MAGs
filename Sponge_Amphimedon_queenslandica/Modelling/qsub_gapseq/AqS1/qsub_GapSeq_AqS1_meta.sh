...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find -p all -t Bacteria -b 200 -c 70 -l MetaCyc -y ./MAGs/AqS1.fasta 
...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find-transport -b 100 -c 70 ./MAGs/AqS1.fasta
...
# # # -b neg
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq draft -r ./AqS1-all-Reactions.tbl -t ./AqS1-Transporter.tbl -p ./AqS1-all-Pathways.tbl -c ./AqS1.fasta -u 100 -l 50 -b neg
...
# Medium prediction
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq medium -m AqS1-draft.RDS -p AqS1-all-Pathways.tbl


# module unload R/3.6.1 # sybilSBML is necessary
# module add R/3.5.3 # sybilSBML is necessary
# 
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq fill -m ./AqS1-draft.RDS -n AqS1-medium.csv -c ./AqS1-rxnWeights.RDS -g ./AqS1-rxnXgenes.RDS -b 50 -o ./2022_pred_diet_AqS1 -r TRUE
# New:
