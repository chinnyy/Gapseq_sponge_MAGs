...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find -p all -t Bacteria -b 200 -c 70 -l MetaCyc -y ./MAGs/AqS2.fasta 
...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find-transport -b 100 -c 70 ./MAGs/AqS2.fasta
...
# # # -b neg
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq draft -r ./AqS2-all-Reactions.tbl -t ./AqS2-Transporter.tbl -p ./AqS2-all-Pathways.tbl -c ./AqS2.fasta -u 100 -l 50 -b neg
...
# Medium prediction
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq medium -m AqS2-draft.RDS -p AqS2-all-Pathways.tbl


# module unload R/3.6.1 # sybilSBML is necessary
# module add R/3.5.3 # sybilSBML is necessary
# 
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq fill -m ./AqS2-draft.RDS -n AqS2-medium.csv -c ./AqS2-rxnWeights.RDS -g ./AqS2-rxnXgenes.RDS -b 50 -o ./2022_pred_diet_AqS2 -r TRUE
# New:
