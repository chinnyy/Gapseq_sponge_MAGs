...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find -p all -t Bacteria -b 200 -c 70 -l MetaCyc -y ./MAGs/AqS3.fasta 
...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find-transport -b 100 -c 70 ./MAGs/AqS3.fasta
...
# # # -b neg
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq draft -r ./AqS3-all-Reactions.tbl -t ./AqS3-Transporter.tbl -p ./AqS3-all-Pathways.tbl -c ./AqS3.fasta -u 100 -l 50 -b neg
...
# Medium prediction
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq medium -m AqS3-draft.RDS -p AqS3-all-Pathways.tbl


# module unload R/3.6.1 # sybilSBML is necessary
# module add R/3.5.3 # sybilSBML is necessary
# 
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq fill -m ./AqS3-draft.RDS -n AqS3-medium.csv -c ./AqS3-rxnWeights.RDS -g ./AqS3-rxnXgenes.RDS -b 50 -o ./2022_pred_diet_AqS3 -r TRUE
# New:
