...
# Dict input files:
dict_seed_reactions_corrected_tsv = '/Users/chiny/Bioinfo/software/gapseq/'+ gapseq_version +'/dat/seed_reactions_corrected.tsv'
dict_seed_met_edited        = '/Users/chiny/Bioinfo/software/gapseq/' + gapseq_version + '/dat/seed_metabolites_edited.tsv'
dict_seed_met_edited_custom = '/Users/chiny/Bioinfo/software/gapseq/' + gapseq_version + '/Shan_output_files/seed_metabolites_edited_Shan.tsv'
# Input and output files:
infile_Smat_flux            = input_dir + '050_model_' + model_id + '_gfM_Smat_fluxes.csv'
outfile_flux_lt0            = input_dir + '051_model_' + model_id + '_gfM_Smat_fluxes.flux_lt0.csv'
outfile_flux_lt0_annot      = input_dir + '052_model_' + model_id + '_gfM_Smat_fluxes.flux_lt0.annotate.tsv'
