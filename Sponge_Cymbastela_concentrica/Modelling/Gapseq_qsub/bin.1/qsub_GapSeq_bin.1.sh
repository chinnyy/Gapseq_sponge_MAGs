...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find -p all -t Bacteria -b 200 -c 70 -l MetaCyc -y ./MAGs/bin.1.fa 
...
#NEW   -T Set user-defined temporary folder (default: false)
#NEW   -O For offline mode (default: false)


# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find-transport -b 100 -c 70 ./MAGs/bin.1.fa
...
# # # -b neg
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq draft -r ./bin.1-all-Reactions.tbl -t ./bin.1-Transporter.tbl -p ./bin.1-all-Pathways.tbl -c ./bin.1.fasta -u 100 -l 50 -b neg
...
# Medium prediction
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq medium -m bin.1-draft.RDS -p bin.1-all-Pathways.tbl


# module unload R/3.6.1 # sybilSBML is necessary
# module add R/3.5.3 # sybilSBML is necessary
# 
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq fill -m ./bin.1-draft.RDS -n bin.1-medium.csv -c ./bin.1-rxnWeights.RDS -g ./bin.1-rxnXgenes.RDS -b 50 -o ./2022_pred_diet_bin.1 -r TRUE
# New:
