...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find -p all -t Bacteria -b 200 -c 70 -l MetaCyc -y ./MAGs/bin.2.fa 
...
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq find-transport -b 100 -c 70 ./MAGs/bin.2.fa
...
# # # -b neg
# New:
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq draft -r ./bin.2-all-Reactions.tbl -t ./bin.2-Transporter.tbl -p ./bin.2-all-Pathways.tbl -c ./bin.2.fasta -u 100 -l 50 -b neg
...
# Medium prediction
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq medium -m bin.2-draft.RDS -p bin.2-all-Pathways.tbl


# module unload R/3.6.1 # sybilSBML is necessary
# module add R/3.5.3 # sybilSBML is necessary
# 
/srv/scratch/z5434493/Softwares/gapseq/gapseq_20220825/gapseq fill -m ./bin.2-draft.RDS -n bin.2-medium.csv -c ./bin.2-rxnWeights.RDS -g ./bin.2-rxnXgenes.RDS -b 50 -o ./2022_pred_diet_bin.2 -r TRUE
# New:
